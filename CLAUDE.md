...
- **Stack**: Java 25 (Temurin), Spring Boot 4.1.x (mínimo Java 17, suporta até Java 26), Spring Batch 6.x, Jasper Reports, PostgreSQL, MongoDB, Keycloak, Airflow, OpenTelemetry Collector + Prometheus/Grafana + Jaeger + Loki, Angular. Construção e borda (ADR-0020): Flyway, Spring Data JPA, Traefik, Mailpit, GitHub Actions, springdoc + openapi-generator. Sem Json Server — o cliente Angular é gerado do OpenAPI.
