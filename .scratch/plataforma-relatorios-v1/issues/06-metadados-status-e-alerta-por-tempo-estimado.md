...
**What to build:** Quem opera o sistema — que entra como ADMINISTRADOR (ADR-0019) — passa a ver o que rodou. Cada Execução de Coleta registra início, fim, duração, contagem de linhas e Status de Processamento — e quando passa do Tempo Estimado de Execução do Relatório, vira processado com alerta. Consultável por API.
...
- [ ] API permite ao ADMINISTRADOR consultar Execuções por Relatório, Data de Referência e status; GERENTE e RELATOR recebem 403 (ADR-0019)
