package br.com.relatorios.processador.emprestimo;
...
@Component
public class CarteiraPorFaixa implements DefinicaoRelatorio {

    @Override
    public String codigo() {
        return "EMPRESTIMO-0001";
    }

    @Override
    public String jrxml() {
        return "jasper/emprestimo-0001.jrxml";
    }
